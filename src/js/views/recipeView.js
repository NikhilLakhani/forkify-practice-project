...
class RecipeView extends View {
  ...
  _errMsg = 'We could not find this recipe. Please try another one!';
  _msg = '';

  addHandelerRecipeDetails(handler) {
    ['hashchange', 'load'].forEach(e => {
      window.addEventListener(e, handler);
    });
  }

  addHandelerServings(handler) {
    ...
    return `
      ...
      <div class="recipe__ingredients">
        ...
        <ul class="recipe__ingredient-list">
          ${this._data.ingredients.map(this._generateIngr).join('')}
        </ul>
      </div>
